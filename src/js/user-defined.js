...
layui.config({
    ...
    function lockPage() {
        layer.open({
            title: false,
            type: 1,
            content: '	<div class="admin-header-lock" id="lock-box" style="text-align:center; width:350px;height:200px;margin-top:30px;border-radius:10px">' +
                ...
                '</div>' +
                '<p style="margin-top:10px">请输入“520”，否则不会解锁成功哦(功能还在完善)！！！</p>' +
                '</div>',
            closeBtn: 0,
            shade: 0.9
        })
